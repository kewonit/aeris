...
import type { AirportPhoto, TafData } from "@/components/ui/airport-info-card/types";
import { requestAirportPhoto, requestTaf } from "@/components/ui/airport-info-card/use-airport-data";
