...
Models are Draco-compressed GLB files stored in `public/models/aircraft/`. A second-tier mapping from ICAO type codes (A320, B738, etc.) refines the assignment when type data is available via the readsb feed.
